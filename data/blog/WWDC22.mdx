...
- iOS and macOS updates focus on UX polish and performance.
- New APIs expand capabilities for notifications, camera, and system integrations.
- Apple Silicon momentum continues with tooling tuned for efficiency.
- Privacy enhancements tighten data access and transparency for apps.
- Practical tip: Target modern APIs and optimize for energy/perf on Apple silicon.
